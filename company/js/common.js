...
/* vid_box 고정처리 및 내부 video스케일 애니메이션 */
...
}).fromTo(cards, { y: 300, z: 200, opacity: 0.8 }, 
    { y: 0, z: 0, duration: 1, ease: "power2.out", stagger: 1 ,opacity: 1 }).to(cards,{y:-300,z:-200,skewY:5,duration:1,ease: "power2.in",stagger: 1 ,},'+=0.5') //앞 애니메이션 끝나고 0.5초쉬었다가 등장
//카드 하나씩 1초간격으로 차례차례 등장시키는 것
